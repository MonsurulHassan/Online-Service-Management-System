	...
	if(!isset($_SESSION["is_login"])){
		...
		$rPassword = $_POST["rPassword"];
			...
			if(($rEmail == "") || ($rPassword == "")){
				...
				$sql = "select * from requesterlogin_tb where r_email = ? and r_password = ?";
...
<body>
	<div class="text-center mt-5">
		...
		<h5 class="mt-3"><i class="fa fa-user-secret"></i> Requester Area</h5>
	</div>
		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<form action="" method="post" class="p-4 shadow">
				  ...
				  <button type="submit" name="rLogin" class="btn btn-outline-danger btn-block mt-4">Login</button>
				</form>
